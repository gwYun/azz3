...
| 2 | 삼성 | 66 | 44 | 3 | .600 | 31 |
| 3 | LG | 63 | 50 | 1 | .558 | 30 |
| 4 | KIA | 62 | 50 | 2 | .554 | 30 |
| 5 | 두산 | 59 | 51 | 4 | .536 | 30 |
| 6 | 롯데 | 50 | 60 | 2 | .455 | 32 |
| 7 | 한화 | 49 | 59 | 3 | .454 | 33 |
| 8 | NC | 48 | 58 | 2 | .453 | 36 |
| 9 | SSG | 47 | 64 | 5 | .423 | 28 |
| 10 | 키움 | 42 | 73 | 3 | .365 | 26 |

한화 7위(8/26 SSG전 1-6 패 = SSG 2연패; 두산도 패해 격차 9.0G 유지), 잔여 33. **조건부 시뮬 가을야구(top5) 진출 = 0.9%** (매직넘버 33경기 중 24승 ≈ 7할 3푼). 6·7·8위 롯데·한화·NC .453~.455 밀집이지만 한화 진출확률(0.9%)이 롯데(0.3%)·NC(0.7%)보다 높음(전력 우위). 추월확률: 두산 0.6/LG 0.3/KIA 0.1%. 전력 스냅샷(8/25 크론): 한화 rs 5.55 ra 5.41, 전력시뮬 56.5%. 잔여 "해볼만"(>.53) 경기가 키움·SSG 7경기뿐. 트렌드: 8/18 10%→8/20 4.4%→8/22 6.7%→8/23 3.5%→8/25 1.6%→8/26 0.9%. 일자별 리포트: `kbo/outputs/hanwha-fall-baseball-2026-08-{22,23,25,26}.html`.
