...
const en = {
  ...
  "wcs.subtitle": "Who broke out at the 2026 World Cup — how far their market value jumps, the fee, and the best-fit destination. Like James Rodríguez after 2014.",
  "wcs.result": "Result",
  "wcs.goldenBoot": "Golden Boot",
  "wcs.youngPlayer": "Young Player",
  "wcs.james.tag": "Most likely 'James' case",
  "wcs.board.title": "Breakout board",
  "wcs.board.sub": "Ranked by market-value jump. Bars show value gained.",
  "wcs.col.player": "Player",
  "wcs.col.jump": "Value jump",
  "wcs.col.dest": "Destination",
  "wcs.col.fee": "Predicted fee",
  "wcs.detail.title": "Top breakouts — best-fit destinations",
  ...
  "wcs.note": "ValueTrack breakout model: individual WC performance drives the value jump, calibrated to James Rodríguez 2014 and disclosed. Big-5-league players only; fees in 2026 value.",
...
const ko: Record<keyof typeof en, string> = {
  ...
  "wcs.subtitle": "2026 월드컵에서 뜬 선수 — 시장가치가 얼마나 뛰는지, 예상 이적료와 가장 적합한 행선지. 2014년 하메스 로드리게스처럼.",
  "wcs.result": "결과",
  "wcs.goldenBoot": "득점왕",
  "wcs.youngPlayer": "영플레이어",
  "wcs.james.tag": "가장 유력한 하메스 케이스",
  "wcs.board.title": "브레이크아웃 보드",
  "wcs.board.sub": "시장가치 급등 순. 막대는 상승한 가치.",
  "wcs.col.player": "선수",
  "wcs.col.jump": "가치 점프",
  "wcs.col.dest": "행선지",
  "wcs.col.fee": "예상 이적료",
  "wcs.detail.title": "상위 브레이크아웃 — 가장 적합한 행선지",
  ...
  "wcs.note": "밸류트랙 브레이크아웃 모델: 개인 대회 활약이 가치 점프를 주도하며 하메스 2014에 보정·공개. 빅5 리그 선수 한정 · 이적료는 2026년 가치.",
