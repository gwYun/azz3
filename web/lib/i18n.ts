...
const en = {
  ...
  "matchup.mode": "Most likely",
  "matchup.h2h.title": "Head-to-head this season",
  "matchup.h2h.sub": "Actual results, not a prediction",
  "matchup.h2h.none": "No completed head-to-head games yet this season.",
  "matchup.h2h.completed": "Final",
  "matchup.h2h.won": "{team} won",
  "matchup.h2h.tie": "Tie",
  "matchup.match": "Match",
  "matchup.median": "median",
  "matchup.runrange": "Projected runs (range)",
  "matchup.total": "Total runs",
  "matchup.iqr": "range",
  "matchup.exact": "Exact distribution · base-out Markov",
  "matchup.homeGames": "{team} home games",
  "matchup.predicted": "Prediction",
  "matchup.tbd": "Date TBD",
  "matchup.lineup.projected": "Projected lineup",
  "matchup.lineup.custom": "Your lineup",
  "matchup.lineup.optimal": "Win-max lineup",
  "matchup.lineup.optimize": "Optimize",
  "matchup.lineup.reset": "Reset",
  "matchup.lineup.moveUp": "Move up",
  "matchup.lineup.moveDown": "Move down",
  "matchup.lineup.editHint": "Reorder the batting order or swap in a bench batter to see the win probability change live.",
  ...
  // Credits (Kakao Pay unlock vouchers)
  "nav.credits": "Credits",
  "credits.title": "Credits",
  "credits.desc": "Buy credits and unlock KBO prediction results.",
  "credits.balanceLabel": "Your credits",
  "credits.storeTitle": "Buy credits",
  "credits.packCredits": "{n} credits",
  "credits.perCredit": "credit",
  "credits.buyPack": "Buy",
  "credits.starting": "Starting…",
  "credits.loginFirst": "Please log in first.",
  "credits.startFailed": "Couldn't start payment. Please try again.",
  "credits.myUnlocks": "Unlocked results",
  "credits.noUnlocks": "No unlocked results yet.",
  ...
  "credits.needMore": "Not enough credits.",
  "credits.zeroBalance": "You have no credits.",
  "credits.buy": "Buy credits",
  "credits.freeTaster": "Free preview",
...
const ko: Record<keyof typeof en, string> = {
  ...
  "matchup.win": "{team} 승리",
  "matchup.mode": "최다 빈도",
  "matchup.h2h.title": "이번 시즌 상대 전적",
  "matchup.h2h.sub": "예측이 아닌 실제 경기 결과",
  "matchup.h2h.none": "이번 시즌 아직 맞대결이 없습니다.",
  "matchup.h2h.completed": "진행 완료",
  "matchup.h2h.won": "{team} 승",
  "matchup.h2h.tie": "무승부",
  "matchup.match": "매치",
  "matchup.median": "중앙값",
  "matchup.runrange": "예상 득점 (범위)",
  "matchup.total": "총득점 예상",
  "matchup.iqr": "범위",
  "matchup.exact": "정확 분포 · 베이스-아웃 마르코프",
  "matchup.homeGames": "{team} 홈 경기",
  "matchup.predicted": "예측",
  "matchup.tbd": "일정 미정",
  "matchup.lineup.projected": "예상 라인업",
  "matchup.lineup.custom": "내 라인업",
  "matchup.lineup.optimal": "승리확률 최대 라인업",
  "matchup.lineup.optimize": "최적 타순",
  "matchup.lineup.reset": "초기화",
  "matchup.lineup.moveUp": "위로",
  "matchup.lineup.moveDown": "아래로",
  "matchup.lineup.editHint": "타순을 바꾸거나 벤치 선수를 넣어 승률 변화를 실시간으로 확인하세요.",
  ...
  "nav.credits": "크레딧",
  "credits.title": "크레딧",
  "credits.desc": "크레딧을 구매하고 KBO 승부예측 결과를 잠금 해제하세요.",
  "credits.balanceLabel": "보유 크레딧",
  "credits.storeTitle": "크레딧 구매",
  "credits.packCredits": "크레딧 {n}개",
  "credits.perCredit": "크레딧",
  "credits.buyPack": "구매",
  "credits.starting": "결제 준비 중…",
  "credits.loginFirst": "먼저 로그인해 주세요.",
  "credits.startFailed": "결제를 시작하지 못했습니다. 다시 시도해 주세요.",
  "credits.myUnlocks": "해제한 결과",
  "credits.noUnlocks": "아직 해제한 결과가 없습니다.",
  ...
  "credits.needMore": "크레딧이 부족합니다.",
  "credits.zeroBalance": "크레딧이 없습니다.",
  "credits.buy": "크레딧 구매",
  "credits.freeTaster": "무료 맛보기",
