...
export default function GlossaryPage() {
  ...
  return (
    <article className="mx-auto max-w-2xl">
      ...
      <p className="mt-3 text-base text-neutral-700">{t("glossary.subtitle")}</p>

      <div className="mt-10 border-t border-neutral-200">
        <div className="grid grid-cols-[10rem_1fr] gap-x-6 border-b border-neutral-200 py-3 text-xs font-semibold uppercase tracking-wide text-neutral-500">
        ...
        <dl className="divide-y divide-neutral-200">
          {FEATURE_ORDER.map((feat) => {
            ...
            return (
              <div
                key={feat}
                className="grid grid-cols-[10rem_1fr] gap-x-6 py-4"
              >
                <dt className="flex flex-col">
                  <span className="font-mono text-sm font-semibold text-neutral-900">
                    {ABBREV[feat]}
                  </span>
                  <span className="text-xs text-neutral-500">{t(fullKey)}</span>
                </dt>
